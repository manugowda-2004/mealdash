            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(isset($_FILES['image']['name']))
                    {
                        ...
                        //check if the file is available or normalizer_get_raw_decomposition
                        if($image_name!= "")
                        {
                            //image available
                            ...
                            $ext = end($tmp); //gets the extension of the image
                            $image_name= "Food-Name-".rand(0000,9999).'.'.$ext;// will rename the image
                            ...
                            if($current_image!="")
                            {
                                ...
                                //check whether the image is removeed or not
                                if($remove==false)
                                {
...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        //to get the value based on query executed
        $row2=mysqli_fetch_assoc($res2);

        //to get the indivisial values of selected food
        $title=$row2['title'];
